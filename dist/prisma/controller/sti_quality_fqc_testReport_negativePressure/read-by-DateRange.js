...
const computedPrismaClient = client_1.db.$extends({
    name: "withParsedDate",
    result: {
        sTI_Quality_FQC_TestReport_NegativePressure: {
            Complete_Date_YEAR: {
                needs: {
                    Complete_Date: true,
                },
                compute(data) {
                    var _a;
                    return data.Complete_Date && ((_a = data.Complete_Date) === null || _a === void 0 ? void 0 : _a.getFullYear());
                },
            },
            Complete_Date_MONTH: {
                needs: {
                ...
                compute(data) {
                    var _a;
                    return data.Complete_Date && ((_a = data.Complete_Date) === null || _a === void 0 ? void 0 : _a.getMonth()) + 1;
                },
            },
            Complete_Date_DATE: {
                needs: {
                ...
                compute(data) {
                    var _a;
                    return data.Complete_Date && ((_a = data.Complete_Date) === null || _a === void 0 ? void 0 : _a.getDate());
                },
            },
            Complete_Date_HOURS: {
                needs: {
                ...
                compute(data) {
                    var _a;
                    return data.Complete_Date && ((_a = data.Complete_Date) === null || _a === void 0 ? void 0 : _a.getHours());
                },
            },
            Complete_Date_MINUTES: {
                needs: {
                    Complete_Date: true,
                },
                compute(data) {
                    var _a;
                    return data.Complete_Date && ((_a = data.Complete_Date) === null || _a === void 0 ? void 0 : _a.getMinutes());
                },
            },
        },
    },
...
const read_by_dateRange = (_a) => __awaiter(void 0, [_a], void 0, function* ({ startDate, endDate }) {
    ...
    try {
        // PROCESS DATA
        const data = yield computedPrismaClient.sTI_Quality_FQC_TestReport_NegativePressure.findMany({
            where: {
                Complete_Date: {
                    gte: startDate,
                    lte: endDate,
