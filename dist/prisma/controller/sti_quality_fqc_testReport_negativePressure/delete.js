...
const db_response_1 = __importDefault(require("@/helper/db_response"));
...
const deleteData = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id }) {
    ...
    try {
        const data = yield client_1.db.sTI_Quality_FQC_TestReport_NegativePressure.delete({
            where: {
                id,
            },
        });
        ...
        console.log(error);
        return db_response_1.default.error_internalServer(null);
    }
});
