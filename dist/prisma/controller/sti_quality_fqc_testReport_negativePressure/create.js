...
const create = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender, private_id, Complete_Date, IPQC_PIC, Job_Order, Product_Line, Mould, Flavor, Sample_Size, Result, Tested_By, ConfirmedBy, Notes, }) {
    ...
    try {
        ...
        const data = yield client_1.db.sTI_Quality_FQC_TestReport_NegativePressure.create({
            data: {
                private_id,
                Complete_Date,
                IPQC_PIC,
