...
exports.readWithMinimumLevel = exports.readWithMinimumLevel_INPUT_SCHEMA = void 0;
...
exports.readWithMinimumLevel_INPUT_SCHEMA = zod_1.z.object({
    sender_id: index_schema_1.db_SCHEMA.shape.user_id,
});
const readWithMinimumLevel = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender_id }) {
    // VALIDATE INPUT
    const validate_input = exports.readWithMinimumLevel_INPUT_SCHEMA.safeParse({
        sender_id,
    });
...
exports.readWithMinimumLevel = readWithMinimumLevel;
