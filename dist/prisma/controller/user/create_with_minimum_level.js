...
exports.createWithMinimumLevel = exports.createWithMinimumLevel_INPUT_SCHEMA = void 0;
...
exports.createWithMinimumLevel_INPUT_SCHEMA = zod_1.z.object({
    ...
    newUser_email: index_schema_1.db_SCHEMA.shape.email.optional(),
    ...
    newUser_contact: index_schema_1.db_SCHEMA.shape.contact.optional(),
    newUser_report_to: index_schema_1.db_SCHEMA.shape.report_to,
    newUser_notes: index_schema_1.db_SCHEMA.shape.notes.optional(),
    newUser_authority_level: index_schema_1.db_SCHEMA.shape.authority_level,
});
const createWithMinimumLevel = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender_id, newUser_id, newUser_user_id, newUser_username, newUser_password, newUser_name, newUser_email, newUser_division, newUser_section, newUser_position, newUser_contact, newUser_report_to, newUser_notes, newUser_authority_level, }) {
    // VALIDATE INPUT
    const validate_input = exports.createWithMinimumLevel_INPUT_SCHEMA.safeParse({
        sender_id,
        newUser_id,
        newUser_user_id,
        newUser_username,
...
exports.createWithMinimumLevel = createWithMinimumLevel;
