...
exports.readOne = exports.readOne_INPUT_SCHEMA = void 0;
...
exports.readOne_INPUT_SCHEMA = zod_1.z.object({
    sender_id: index_schema_1.db_SCHEMA.shape.user_id,
    search_id: index_schema_1.db_SCHEMA.shape.user_id,
});
const readOne = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender_id, search_id }) {
    // VALIDATE INPUT
    const validate_input = exports.readOne_INPUT_SCHEMA.safeParse({
        sender_id,
        search_id,
    });
