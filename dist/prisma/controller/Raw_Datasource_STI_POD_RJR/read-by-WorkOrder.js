...
exports.read_by_workOrder = exports.read_by_workOrder_INPUT_SCHEMA = void 0;
...
exports.read_by_workOrder_INPUT_SCHEMA = zod_1.z.object({
    workOrder: index_schema_1.db_SCHEMA.shape.production_order_number,
});
const read_by_workOrder = (_a) => __awaiter(void 0, [_a], void 0, function* ({ workOrder }) {
    const validate_input = yield exports.read_by_workOrder_INPUT_SCHEMA.safeParseAsync({ workOrder });
    ...
    try {
        ...
        const data = yield computedPrismaClient.raw_Datasource_STI_POD_RJR.findMany({
            where: {
                production_order_number: validate_input.data.workOrder,
            },
            orderBy: {
                tanggal_mulai: "asc",
            },
...
exports.read_by_workOrder = read_by_workOrder;
