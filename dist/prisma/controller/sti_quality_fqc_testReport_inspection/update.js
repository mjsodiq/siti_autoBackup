...
const update = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id, private_id, Manufacture_Date, Batch_Number, Job_Order, Product_Line, Flavor, Sampel_Size, Defect_Quantity, Defect_Rate, Defect_Description_Note, Defect_Description, Result, Completed_Date, Note, Tested_By, Verified_By, Verification_Date, }) {
    ...
    try {
        const data = yield client_1.db.sTI_Quality_FQC_TestReport_Inspection.update({
            where: {
                id,
            },
            data: {
