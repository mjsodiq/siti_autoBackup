...
exports.create_INPUT_SCHEMA = zod_1.z.object({
    ...
    Combined_Samples_With_Inspection: index_schema_1.db_SCHEMA.shape.Combined_Samples_With_Inspection.optional(),
    Tested_By: index_schema_1.db_SCHEMA.shape.Tested_By.optional(),
});
const create = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender, private_id, Manufacture_Date, Job_Order, Product_Line, Flavor, Sampel_Size, Combined_Samples_With_Inspection, Defect_Quantity, Defect_Rate, Defect_Description_Note, Defect_Description, Result, Completed_Date, Note, Tested_By, }) {
    const validate_input = yield exports.create_INPUT_SCHEMA.safeParseAsync({
        ...
        Flavor,
        Sampel_Size,
        Combined_Samples_With_Inspection,
        Defect_Quantity,
        Defect_Rate,
    ...
    try {
        const data = yield client_1.db.sTI_Quality_FQC_TestReport_FAI.create({
            data: {
                private_id,
                Manufacture_Date,
                Job_Order,
