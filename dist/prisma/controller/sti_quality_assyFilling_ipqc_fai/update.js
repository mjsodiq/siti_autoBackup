...
const update = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender, id, creator_id, WorkOrder, Line, Section, LaserCode, date, FAI_StartTime, FAI_FinishTime, CPK, Image1, Image2, Image3, Notes, }) {
    ...
    try {
        ...
        const data = yield client_1.db.sTI_Quality_AssyFilling_IPQC_FAI.update({
            where: {
                id,
            },
            data: {
