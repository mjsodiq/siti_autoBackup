...
const readOne_by_ID_INPUT_SCHEMA = zod_1.z.object({
    sender: index_schema_2.user_id,
    id: index_schema_1.db_SCHEMA.shape.id,
});
const readOne_by_ID = (_a) => __awaiter(void 0, [_a], void 0, function* ({ sender, id }) {
    const validate_input = yield readOne_by_ID_INPUT_SCHEMA.safeParseAsync({
        sender,
        id,
    });
    ...
    try {
        const data = yield client_1.db.sTI_Quality_AssyFilling_IPQC_FAI.findFirst({
            where: {
                id,
            },
            include: {
...
exports.readOne_by_ID = readOne_by_ID;
