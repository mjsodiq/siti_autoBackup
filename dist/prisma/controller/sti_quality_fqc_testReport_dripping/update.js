...
exports.update_INPUT_SCHEMA = zod_1.z.object({
    ...
    Move_To: index_schema_1.db_SCHEMA.shape.Move_To.optional(),
...
const update = (_a) => __awaiter(void 0, [_a], void 0, function* ({ id, private_id, Manufacture_Date, Job_Order, Product_Line, Flavor, Sampel_Size, Defect_Quantity, Defect_Rate, Defect_Description_Note, Defect_Description, Result, Completed_Date, Note, Tested_By, Move_To, Verified_By, Verification_Date, }) {
    ...
    try {
        const data = yield client_1.db.sTI_Quality_FQC_TestReport_Dripping.update({
            where: {
                id,
            },
            data: {
